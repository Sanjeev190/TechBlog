...
document.getElementById('blogContainer').addEventListener('click', async function(event) {
    if (event.target.classList.contains('edit-btn')) {
      ...
      const blogTitle = event.target.closest('.blog-card').querySelector('.blog-title').innerText;
        ...
        document.querySelector("#blogTitle").value = blogTitle;
        document.querySelector("#blogContent").value = blogContent;
        const modalElement = document.querySelector("#blogModal");
        const modalInstance = bootstrap.Modal.getInstance(modalElement);
        modalInstance.show();
        document.querySelector("#blogForm").addEventListener("submit", async function (event) {
...
//       const blogTitle = this.closest('.blog-card').querySelector('.blog-title').innerText;
//       const blogContent = this.closest('.blog-card').querySelector('.blog-text').innerText;
  
//       // Prefill the modal form with current blog details
//       document.querySelector("#blogTitle").value = blogTitle;
//       document.querySelector("#blogContent").value = blogContent;
      
//       // Open the modal (assume you already have modal handling)
//       const modalElement = document.querySelector("#blogModal");
//       const modalInstance = bootstrap.Modal.getInstance(modalElement);
//       modalInstance.show();
